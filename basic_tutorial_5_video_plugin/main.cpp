...
int main(int argc, char *argv[]) {
  ...
  auto deep_plugin = gst_element_factory_make("myvideo", "myvideo");
  ...
  if (!deep_plugin) {
    g_printerr("Our plugin cannot be loaded. Be sure libmyvideo.so is in the folder where the program starts\n");
    return -2;
  }
